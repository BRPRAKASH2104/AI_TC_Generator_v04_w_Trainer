"""
Context-Rich, High-Performance Test Case Generator with Enhanced Logging

Version: Refactored v1.3 - With YAML Prompt Management, XLSX Output, and Structured Logging
...
class AITestLogger:
    ...
    def print_banner(self) -> None:
        ...
        banner_text = Text()
        banner_text.append("AI Test Case Generator v1.3\n", style="bold blue")
        banner_text.append(
