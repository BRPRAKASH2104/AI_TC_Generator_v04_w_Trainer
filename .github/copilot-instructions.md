...
## Project Overview
This is a modular Python 3.14+ system for generating AI-powered test cases from automotive REQIFZ requirements files. It features a unified CLI (`main.py` and `ai-tc-generator`), high-performance async processing, vision model support (llama3.2-vision:11b), and comprehensive error handling. The architecture is designed for maintainability, scalability, and rapid development/testing.
...
## Developer Workflow
- **Environment:** Python 3.14+, install with `pip install -e .[dev]`.
...
- **Type Check:** Use `mypy src/ main.py --python-version 3.14`.
...
---
For more details, see `CLAUDE.md` and `docs/README.md`. All instructions here are based on validated, discoverable project patterns as of 2025-11-09.
