...
## Git & Workflow Rules
See @commit.md for Git and PR instructions.
---
...
This project is indexed by GitNexus as **AI_TC_Generator_v04_w_Trainer** (5142 symbols, 7280 relationships, 139 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Training area (85 symbols) | `.claude/skills/generated/training/SKILL.md` |
...
| Work in the Cluster_90 area (8 symbols) | `.claude/skills/generated/cluster-90/SKILL.md` |
