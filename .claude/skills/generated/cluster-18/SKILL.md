---
name: cluster-18
description: "Skill for the Cluster_18 area of AI_TC_Generator_v04_w_Trainer. 9 symbols across 3 files."
---
...
- **`parse_and_augment_relationships`** (Method) — `src/core/extractors.py:477`
...
| `_augment_relationships_if_enabled` | Method | `src/core/extractors.py` | 83 |
