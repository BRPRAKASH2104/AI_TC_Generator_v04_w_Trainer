---
name: cluster-99
description: "Skill for the Cluster_99 area of AI_TC_Generator_v04_w_Trainer. 8 symbols across 2 files."
---
...
- **`create_test_information`** (Function) — `tests/helpers/test_artifact_builder.py:151`
- **`create_test_interface`** (Function) — `tests/helpers/test_artifact_builder.py:174`
- **`create_augmented_requirement`** (Function) — `tests/helpers/test_artifact_builder.py:303`
...
| `test_create_augmented_requirement` | Method | `tests/helpers/test_artifact_builder_verification.py` | 102 |
...
2. `query({search_query: "cluster_99"})` — find related execution flows
