---
name: cluster-21
description: "Skill for the Cluster_21 area of AI_TC_Generator_v04_w_Trainer. 6 symbols across 1 files."
---
...
- **`format_to_excel_streaming`** (Method) — `src/core/formatters.py:293`
...
| `format_to_excel` | Method | `src/core/formatters.py` | 42 |
| `format_to_excel_streaming` | Method | `src/core/formatters.py` | 293 |
| `_create_formatted_excel` | Method | `src/core/formatters.py` | 203 |
| `_apply_excel_formatting` | Method | `src/core/formatters.py` | 229 |
| `_add_metadata_sheet` | Method | `src/core/formatters.py` | 271 |
| `_write_chunk_to_excel` | Method | `src/core/formatters.py` | 366 |
