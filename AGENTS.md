...
This project is indexed by GitNexus as **AI_TC_Generator_v04_w_Trainer** (4815 symbols, 6918 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
